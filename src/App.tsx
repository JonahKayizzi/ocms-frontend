      ...
      <Router>
        <div className="min-h-screen bg-gray-50">
          <Routes>
            ...
            <Route path="/online-course/dashboard" element={<CourseManagementDashboard />} />
            <Route path="/online-obj-assessment/dashboard" element={<CourseManagementDashboard />} />
            {/* Use legacy CoursePage for public course view (same design as SMS) */}
            <Route path="/course/:id" element={<CoursePage />} />
            {/* Original routes */}
            <Route path="/course/:id/legacy" element={<CoursePage />} />
            <Route path="/course/:id/outline" element={<CourseOutline modules={courseData.modules} />} />
            <Route path="/course/:id/materials" element={<DownloadableMaterials materials={courseData.materials} />} />
            <Route
              path="/course/:id/video"
              element={(
                <VideoSection
                  currentLesson={courseData.progress.currentLesson}
                  currentLessonNumber={courseData.progress.currentLessonNumber}
